...
<h1 className="text" style={{ color: "white", textAlign: "center"}}>Documents Required for a Business loan</h1><br></br><br></br>
            <p style={{ color: "white", wordSpacing: "4px", marginLeft:"20px"}}> To apply for a business loan from one of FinURL's lending partners, you must have the following documents:

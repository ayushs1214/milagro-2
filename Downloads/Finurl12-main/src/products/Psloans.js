  ...
  return (
    <div className="bg-black">
      ...
      <div className="pscontainer overflow-x-hidden">
        ...
        <p className="ps text-white" style={{ wordSpacing: "4px" }}>
          *The interest rates and associated charges can vary from one lending partner to the other and are subject to policy changes of the partner.
          <br />
          <br />
          At Bajaj Markets, we connect you with the best personal loan lending partners across India. You can compare personal loans and pick from the best lenders based on your convenience and apply for an instant loan on terms that you deem to be favorable.
        </p>
        <br />
     ...
     <div className='table1'>    <table className="text-white">
        ...
        <br />
       <center><ul className=" pslist" style={{  listStyle: "none", color: "white", wordWrap:"break-word" }}>
        ...
        <ul className="psl text-white" style={{ justifyContent: "left", listStyle: "outside", color: "white", textAlign:"justify" }}>
          ...
          <br />
          <li><b>Home Renovation:</b> If you have been trying to give your home a makeover, an instant personal loan can help you do just that. Courtesy of the money that you avail of as a personal loan, you will be able to manage the necessary expenses connected to home renovation and repair. Moreover, you can repay it over a flexible tenure of your choice.</li>
          <br />
          <li><b>Higher Education:</b> A personal loan can also be used to pay for higher education. Personal loans are generally taken to meet expenses such as course fees, travel-related costs, and lodging/accommodation charges, among others.</li>
          <br />
          <li><b>Medical Exigency:</b> A medical emergency can lead to financial trouble. Such emergencies can also force you to ask for assistance from your family and friends. To deal with such an emergency, you can apply for a personal loan for medical emergencies.</li>
          <br />
